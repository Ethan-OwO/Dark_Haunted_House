...
public class SceneManager {
    ...
    public static void showMainMenu() { stage.setScene(new MainMenuScene().build()); }
    ...
    public static void showGameOver() { stage.setScene(new GameOverScene().build()); }

    public static void showVictory()  { stage.setScene(new VictoryScene().build());  }
}
